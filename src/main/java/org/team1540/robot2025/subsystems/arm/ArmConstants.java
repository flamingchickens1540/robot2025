...
public class ArmConstants {
    ...
    public static final double MOTOR_TO_CANCODER = (72.0 / 12.0) * (84.0 / 18.0);
    public static final double CANCODER_OFFSET_ROTS = -0.740234375; // TODO: get offset
    ...
    public static final Rotation2d ERROR_TOLERANCE = Rotation2d.fromDegrees(3.0);
}
