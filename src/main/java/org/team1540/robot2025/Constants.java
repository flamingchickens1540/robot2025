...
public final class Constants {
    ...
    public static final double BUMPER_LENGTH_X_METERS = Units.inchesToMeters(18.719 * 2);
    public static final double BUMPER_LENGTH_Y_METERS = Units.inchesToMeters(18.470 * 2);
}
